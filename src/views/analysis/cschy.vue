<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('product.monitorTime')" align="center" width="200px">
        <template slot-scope="{row}">
          <span>{{ row.monitorTime }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('product.houdu1')" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.houdu1 }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('product.fushisulv1')" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.fushisulv1 }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('product.houdu1')" width="200px" align="center">
        <template slot-scope="{row}">
